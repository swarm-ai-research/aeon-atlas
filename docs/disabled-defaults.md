...
> Auto-generated by `scripts/atlas.mjs` on 2026-06-28. Which upstream-enabled skills are systematically turned off by forks?
...
Ships **2** skill(s) enabled by default. Disable rates across **190** forks:

| Skill | Disabled by | Rate |
|---|---:|---:|
| `skill-enabler` | 106 / 190 | **56%** |
| `heartbeat` | 0 / 190 | **0%** |
...
- **`aaronjmars/aeon` → `skill-enabler`** — disabled by 56% of forks (106 / 190).
