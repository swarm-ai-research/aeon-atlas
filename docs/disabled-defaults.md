...
|---|---:|---:|
| `fleet-skill-adoption` | 116 / 139 | **84%** |
| `skill-enabler` | 111 / 139 | **80%** |
| `heartbeat` | 0 / 139 | **0%** |
...
- **`fleet-skill-adoption`** — disabled by 84% of forks (116 / 139).
- **`skill-enabler`** — disabled by 80% of forks (111 / 139).
